...
$(document).ready(function () {
	...
	$('#signature').click(function () {
		...
		$('.subtext').html("I make stuff.<br>Check out some stuff I do. (I also have a <a href=\"docs/resume.pdf?v=2.00\" target=\"_blank\">resume</a>)")
	})
	...
	$('#school').click(function () {
		...
		$('.subtext').animate({
			...
			$(this).html(`
			<img src="img/bthslogo.png" style="height:5em" />
			<b>
				<p>I am a Junior currently attending Brooklyn Technical High School.<br>Brooklyn Tech is the largest high school in
					America with over 5,900 students and taking up the real estate of one whole city block.<br>I am currently on track to
					graduate with a Advanced Regents Diploma, CTE Certification, and Brooklyn Tech Diploma with accreditations from the
					National Honor Society.<br><br>Here are some of the more challenging classes I\'ve taken thus far:<br>
					<ul>
						<li>AP World History</li>
						<li>AP Computer Science Principles</li>
						<li>AP Capstone Seminar</li>
